...
2. After applying a fix → check_status before doing anything else
3. After a correct diagnose → take the fix action on the root cause, then verify if victims need fixing.
