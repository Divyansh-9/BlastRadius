...
Before jumping into GRPO (RL), we must teach the small 7B model (4-bit
QLoRA) the correct OUTPUT FORMAT and domain vocabulary. If we skip this,
...
def main():
    ...
    # Default updated from DeepSeek-R1-Distill-Qwen-32B (OOMs A100 80GB at full precision)
    # to the 4-bit Qwen2.5-7B-Instruct used by the v2 training notebook (~4.5GB VRAM).
    parser.add_argument("--model", default="unsloth/Qwen2.5-7B-Instruct-bnb-4bit", help="Base model")
